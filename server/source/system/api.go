...
func (i *initApi) InitializeData(ctx context.Context) (context.Context, error) {
	...
	entities := []sysModel.SysApi{
		...
		{ApiGroup: "Amazon首页", Method: "POST", Path: "/amazonDashboard/overview", Description: "查询 Amazon 首页数据"},
		{ApiGroup: "Amazon店铺", Method: "POST", Path: "/amazonStore/list", Description: "查询 Amazon 店铺列表"},
		{ApiGroup: "Amazon物流", Method: "POST", Path: "/amazonLogistics/quoteUS", Description: "查询美国直发物流最低价"},
		{ApiGroup: "Amazon物流报价库", Method: "POST", Path: "/amazonLogisticsLibrary/uploadWorkbook", Description: "上传物流报价Excel并解析入库"},
		{ApiGroup: "Amazon物流报价库", Method: "POST", Path: "/amazonLogisticsLibrary/getChannelPage", Description: "查询物流报价库主列表"},
		{ApiGroup: "Amazon物流报价库", Method: "POST", Path: "/amazonLogisticsLibrary/getChannelDetail", Description: "查询物流报价详情"},
		{ApiGroup: "Amazon物流报价库", Method: "POST", Path: "/amazonLogisticsLibrary/getRateRowPage", Description: "查询物流报价费率分页"},
		{ApiGroup: "Amazon物流报价库", Method: "POST", Path: "/amazonLogisticsLibrary/getVersionPage", Description: "查询物流报价版本历史"},
		{ApiGroup: "Amazon模板", Method: "POST", Path: "/amazonTemplate/create", Description: "创建 Amazon 模板"},
		{ApiGroup: "Amazon模板", Method: "PUT", Path: "/amazonTemplate/update", Description: "更新 Amazon 模板"},
		{ApiGroup: "Amazon模板", Method: "DELETE", Path: "/amazonTemplate/delete", Description: "删除 Amazon 模板"},
		{ApiGroup: "Amazon模板", Method: "GET", Path: "/amazonTemplate/find", Description: "查询 Amazon 模板"},
		{ApiGroup: "Amazon模板", Method: "POST", Path: "/amazonTemplate/list", Description: "查询 Amazon 模板列表"},
		{ApiGroup: "Amazon模板", Method: "POST", Path: "/amazonTemplate/uploadWorkbook", Description: "上传 Amazon 模板工作簿"},
		{ApiGroup: "Amazon模板", Method: "GET", Path: "/amazonTemplate/downloadWorkbook", Description: "下载 Amazon 模板工作簿"},
		{ApiGroup: "Amazon模板", Method: "GET", Path: "/amazonTemplate/parseWorkbook", Description: "解析 Amazon 模板工作簿"},
		{ApiGroup: "Amazon模板", Method: "POST", Path: "/amazonTemplate/saveFieldRules", Description: "保存 Amazon 模板字段规则"},
		{ApiGroup: "Amazon上架", Method: "POST", Path: "/amazonListingFamily/create", Description: "创建 Amazon 变体族"},
		{ApiGroup: "Amazon上架", Method: "PUT", Path: "/amazonListingFamily/update", Description: "更新 Amazon 变体族"},
		{ApiGroup: "Amazon上架", Method: "DELETE", Path: "/amazonListingFamily/delete", Description: "删除 Amazon 变体族"},
		{ApiGroup: "Amazon上架", Method: "GET", Path: "/amazonListingFamily/find", Description: "查询 Amazon 变体族"},
		{ApiGroup: "Amazon上架", Method: "POST", Path: "/amazonListingFamily/list", Description: "查询 Amazon 变体族列表"},
		{ApiGroup: "Amazon上架", Method: "POST", Path: "/amazonListing/save", Description: "保存 Amazon 商品"},
		{ApiGroup: "Amazon上架", Method: "DELETE", Path: "/amazonListing/delete", Description: "删除 Amazon 商品"},
		{ApiGroup: "Amazon上架", Method: "GET", Path: "/amazonListing/find", Description: "查询 Amazon 商品"},
		{ApiGroup: "Amazon上架", Method: "POST", Path: "/amazonListing/list", Description: "查询 Amazon 商品列表"},
		{ApiGroup: "Amazon上架", Method: "POST", Path: "/amazonListing/validateItem", Description: "校验 Amazon 商品"},
		{ApiGroup: "Amazon上架", Method: "POST", Path: "/amazonListing/validateSelected", Description: "批量校验 Amazon 商品"},
		{ApiGroup: "Amazon上架", Method: "POST", Path: "/amazonListing/exportSelected", Description: "导出 Amazon 商品"},
		{ApiGroup: "Amazon上架", Method: "POST", Path: "/amazonListingProfit/calculate", Description: "计算 Amazon 利润试算"},
		{ApiGroup: "Amazon图片", Method: "POST", Path: "/amazonListingImage/upload", Description: "上传 Amazon 图片"},
		{ApiGroup: "Amazon图片", Method: "DELETE", Path: "/amazonListingImage/delete", Description: "删除 Amazon 图片关联"},
		{ApiGroup: "Amazon图片", Method: "POST", Path: "/amazonListingImage/sort", Description: "排序 Amazon 图片"},
